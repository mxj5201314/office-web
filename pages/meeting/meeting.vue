	...
	<view class="page">
		...
		<view class="members">
			...
			<view class="member">
				...
				<view class="add"><image src="../../static/icon-19.png" mode="widthFix" class="add-btn" /></view>
			</view>
		</view>
		<button class="btn">保存</button>
		<uni-popup ref="popupPlace" type="dialog"><uni-popup-dialog mode="input" title="编辑文字内容" :value="place" placeholder="输入会议地点" /></uni-popup>
		<uni-popup ref="popupDesc" type="dialog"><uni-popup-dialog mode="input" title="编辑文字内容" :value="desc" placeholder="输入会议内容" /></uni-popup>
	</view>
</template>
